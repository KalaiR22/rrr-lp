...
const Nav = () => {
    ...
    return (
            ...
            <nav
                className={`lg:px-14 px-4 ${isSticky ? "bg-[#0d0517] text-white shadow-md" : "bg-[#0d0517]/20  backdrop-blur-md text-white"} transition-all duration-300 ease-in-out`}
                style={{ padding: '0 5%' }}
            >
                <div className='flex justify-between items-center py-4'>
                    ...
                    <a href="/" className='text-2xl font-semibold'>
                        <img
                            src={logo}
                            alt="Logo"
                            className='w-16 h-16 md:w-18 md:h-18 lg:w-16 lg:h-16 object-contain rounded-full'
                        />
                    </a>
                            ...
                            {navItems.map(({ link, path }) => (
                                <li key={path}>
                                    <Link
                                        ...
                                        offset={-50}
                                        duration={300}
                                        className={`block text-base lg:text-xl font-normal font-roboto cursor-pointer hover:text-[#8689EB] transition-colors duration-300`} // Reduced font size on md screens
